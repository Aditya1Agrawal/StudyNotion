...
exports.createCourse =async(req,res)=>{
   try{
    ...
    const thumbnailupload =await uploadImagetoCloudinary(thumbnail,process.env.FOLDER)
    ...
    categoryDetails.courses.push(CourseDetails._id)
